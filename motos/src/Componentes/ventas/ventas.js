    ...
    <body className="sales">
      ...
      <header className="principal" id="inicio">
        ...
        <div className="contenedor head">
          ...
          <p className="copy">
            Mundo motos, le ofrece gran variedad de artículos, donde encontraras
            varios estilos para ti y toda tu familia. Contamos con gran variedad
            de accesorios y repuestos. Te invitamos a seguirnos en nuestras
            plataformas digitaleso en nuestra tienda fisísca
          </p>
        </div>
      </header>
      <main>
        <section className="gallery">
          <div className="contenedor">
            <p className="copy">
              Si quieres ver todos nuestros prodructos en un genial Lightbox te
              invitamos a que des click en el siguiente boton 👇 <br></br>
              <Lightbox />
            </p>
          </div>
        </section>
        <section className="gallery" id="motos">
          <div className="contenedor">
            ...
            <p className="copy">
              En esta sección encontraras varias de nuestras motos de excelente
              calidad, contamos con motocicletas para niños, o si eres de esas
              personas que te gusta salir a explorar otros aires contamos con
              ciertas motocicletas de muy buena calidad, ademas tenemos un
              descuento del 15% para adquirir el combo familiar.
            ...
            <div className="contenedor-galeria">
              ...
              <div className="informacion">
                ...
                <p className="inf">
                  ...
                  Tipo de motor 4 tiempos (OHV) <br></br> Refrigerado por
                  liquido <br></br>
            ...
            <div className="contenedor-galeria">
              ...
              <div className="informacion">
                ...
                <p className="inf">
                  ...
                  Tipo de motor: 4 tiempos 2 <br></br> valvúlas (SOHC)
                  Refrigerado por aire <br></br>
            ...
            <div className="contenedor-galeria">
              ...
              <div className="informacion">
                <h2 className="subtituloo">Ninja H2 2023</h2>
                <p className="inf">
                  Color: personalizado <br></br>
                  Cilindraje: 998 cc <br></br>
                  Tipo de motor: 4 tiempos <br></br> sobrealimentado de cuatro
                  cilindro <br></br>
                  Valor: $95.980.000
                </p>
                <div className="carrito">
            ...
            <div className="contenedor-galeria">
              ...
              <div className="informacion">
                <h2 className="subtituloo">YZF-R6 2023</h2>
                <p className="inf">
                  Color: personalizado <br></br>
                  Cilindraje: 599 cc <br></br>
                  Tipo de motor: 4 tiempos (DOCH) <br></br> Refrigerado por
                  liquido <br></br>
            ...
            <div className="contenedor-galeria">
              ...
              <div className="informacion">
                ...
                <p className="inf">
                  Color: personalizado <br></br>
                  Cilindraje: cc <br></br>
                  Tipo de motor: 4 valvulas (SOHC) <br></br> refrigerado por
                  liquido <br></br>
            ...
            <div className="contenedor-galeria">
              ...
              <div className="informacion">
                <h2 className="subtituloo">R15 2024</h2>
                <p className="inf">
                  Color: personalizado <br></br>
            ...
            <div className="contenedor-galeria">
              ...
              <div className="informacion">
                <h2 className="subtituloo">Motos enduro XTZ-250 2012</h2>
                <p className="inf">
                  Color: personalizado <br></br>
                  Cilindraje: 249 cc <br></br>
                  Tipo de motor: 4T (SOCH) Refrigerado <br></br> por aire y
                  aceite <br></br>
            ...
            <div className="contenedor-galeria">
              ...
              <div className="informacion">
                <h2 className="subtituloo">Suzuki DR-200SE</h2>
                <p className="inf">
                  Color: personalizado <br></br>
                  Cilindraje: 199 cc <br></br>
                  Tipo de motor: 4 tiempos (SOCH) <br></br> refrigerado por aire
                  y aceite <br></br>
            ...
            <div className="contenedor-galeria">
              ...
              <div className="informacion">
                <h2 className="subtituloo">KTM 350 SX-F 2023</h2>
                <p className="inf">
            ...
            <div className="contenedor-galeria">
              ...
              <div className="informacion">
                <h2 className="subtituloo">Yamaha YZ125 2022</h2>
                <p className="inf">
                  Color: personalizado <br></br>
            ...
            <div className="contenedor-galeria">
              ...
              <div className="informacion">
                <h2 className="subtituloo">BOXER S PRO</h2>
                <p className="inf">
                  Color: personalizado <br></br>
            ...
            <div className="contenedor-galeria">
              ...
              <div className="informacion">
                <h2 className="subtituloo">Boxer S</h2>
                <p className="inf">
                  Color: personalizado <br></br>
                  Cilindraje: 102 cc <br></br>
                  Tipo de motor: 4 tiempos monocilindrico <br></br>
            ...
            <div className="contenedor-galeria">
              ...
              <div className="informacion">
                <h2 className="subtituloo">Cuatrimoto YFM90R</h2>
                <p className="inf">
                  Color: personalizado <br></br>
                  Cilindraje: 90 cc <br></br>
                  Tipo de motor: 4 tiempo (SOCH), 2 valvulas, <br></br>{" "}
                  refrigeradopor aire <br></br>
                  Potencia maxima: 7.59 HP a 7500 rpm <br></br>
                  Valor: $20.000.000
                </p>
                <div className="carrito">
            ...
            <div className="contenedor-galeria">
              ...
              <div className="informacion">
                <h2 className="subtituloo">Cuatrimoto todos los tamaños</h2>
                <p className="inf">
                  Color: personalizado <br></br>
        ...
        <section className="gallery" id="accesorios">
          <div className="contenedor">
            <h2 className="subtitulo">Nuestros árticulos</h2>
            <p className="copy">
              Aqui podrás encontrar, artículos con los que cuenta nuestra
              tienda, garantizados y de excelente calidad.
            </p>
            <div className="contenedor-galeria">
              ...
              <div className="informacion">
                ...
                <p className="inf">
                  ...
                  guantes con protección en nudillos <br></br>y botas
                  impermeables <br></br>
                  Valor: $588.000
                </p>
                <div className="carrito">
            ...
            <div className="contenedor-galeria">
              ...
              <div className="informacion">
                <h2 className="subtituloo">Chamarra de cuero</h2>
                <p className="inf">
                  Color: personalizado <br></br>
                  Descripción: Chaqueta de proteccion para <br></br>{" "}
                  motociclistas antifricción <br></br>
                  Valor: $208.710
                </p>
                <div className="carrito">
                  <i class="bx bxs-cart"></i>
            ...
            <div className="contenedor-galeria">
              ...
              <div className="informacion">
                <h2 className="subtituloo">Casco plano certificado</h2>
                <p className="inf">
                  Color: personalizado <br></br>
            ...
            <div className="contenedor-galeria">
              ...
              <div className="informacion">
                <h2 className="subtituloo">Kit para motociclista</h2>
                <p className="inf">
                  Color: personalizado Descripción: Chaqueta de piel, <br></br>
            ...
            <div className="contenedor-galeria">
              ...
              <div className="informacion">
                <h2 className="subtituloo">Kit para motociclista economico</h2>
                <p className="inf">
                  Color: personalizado <br></br>
        ...
        <section className="gallery" id="repuestos">
          <div className="contenedor">
            <h2 className="subtitulo">Repuestos y herramientas</h2>
            <p className="copy">
              En esta sección encontrarás, artículos indispensables para el
              mantenimiento y buen funcionamiento de tu vehículo. haz tu pedido
              y lo llevaremos hasta tu ubicación.
            </p>
            <div className="contenedor-galeria">
              ...
              <div className="informacion">
                ...
                <p className="inf">Valor: $480.000</p>
                <div className="carrito">
                  <i class="bx bxs-cart"></i>
                </div>
              </div>
            ...
            <div className="contenedor-galeria">
              ...
              <div className="informacion">
                ...
                <p className="inf">Valor: $750.000</p>
                <div className="carrito">
                  <i class="bx bxs-cart"></i>
                </div>
              </div>
            ...
            <div className="contenedor-galeria">
              ...
              <div className="informacion">
                <h2 className="subtituloo">Llaves mixtas</h2>
                <p className="inf">Valor: $15.000 c/u</p>
                <div className="carrito">
                  <i class="bx bxs-cart"></i>
                </div>
              </div>
            ...
            <div className="contenedor-galeria">
              ...
              <div className="informacion">
                ...
                <p className="inf">Valor: $189.000</p>
                <div className="carrito">
                  <i class="bx bxs-cart"></i>
                </div>
              </div>
